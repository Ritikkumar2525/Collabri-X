...
const Login = () => {
    ...
    return (
        <div className="flex min-h-screen items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-dark relative overflow-hidden">
            ...
            <div className="absolute -top-24 -left-24 w-96 h-96 bg-red-accent/20 rounded-full blur-3xl opacity-50" />
            <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-red-accent/20 rounded-full blur-3xl opacity-50" />
            ...
            <div className="w-full max-w-md space-y-8 bg-dark-lighter p-10 rounded-[2rem] shadow-xl shadow-black/50/50 border border-white/5 relative z-20 transition-all">
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="relative py-2">
                        ...
                        <div className="relative flex justify-center text-xs font-medium uppercase">
                            <span className="bg-dark-lighter px-2 text-gray-500 tracking-widest">or continue with email</span>
                        </div>
                    </div>
                ...
                <div className="text-center pt-2 mt-6 border-t border-white/5">
                    <p className="text-sm text-gray-500 font-medium">
                        New here?{' '}
                        <Link to="/register" className="font-medium text-red-accent hover:text-red-500 transition-colors">
                            Create an account
                        </Link>
                    </p>
                </div>
